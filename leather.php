...
<?php
    $where="where furniture_collection='2' and furniture_status='1'"
?>
<html>
...
<head>
    ...
    <title>LEATHER FURNITURE PAGE</title>
...
<body>
    ...
    <div class="container-fluid main2 mb-5">
        <div class="container">
            <div class="row">
                <div class="text-center contact-main1-head mt-5 fs-2 fw-bold">Leather <span> Furniture </span> </div>
                <div class="col-lg-12">
                    ...
                    <div class="card furniture-card h-auto">
                        ...
                        <div class="card-body crd-body">
                            <p class="card-text crd-text fw-bold">
                                RS, <?php echo $fetch['discounted_price']; ?> &nbsp;&nbsp;&nbsp;&nbsp;
                                <span> <strike> ₹<?php echo $fetch['furniture_price']; ?></strike> &nbsp;&nbsp;&nbsp;&nbsp;</span>
