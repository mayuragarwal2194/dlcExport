...
<?php
    $where="where furniture_collection='1' and furniture_status='1'"
?>
<html>
...
<head>
    ...
    <title>IRON FURNITURE PAGE</title>
...
<body>
    ...
    <div class="container-fluid main2 mb-5">
        <div class="container">
            <div class="row">
                <div class="text-center contact-main1-head mt-5 fs-2 fw-bold">Iron <span> Furniture </span> </div>
                <div class="col-lg-12">
