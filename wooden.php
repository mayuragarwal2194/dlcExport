...
<?php
    $where="where furniture_collection='0' and furniture_status='1'";
?>
<html>
...
<head>
    ...
    <title>WOODEN FURNITURE PAGE</title>
                    ...
                    <div class="card furniture-card h-auto">
                        ...
                        <div class="card-body crd-body">
                            <p class="card-text crd-text fw-bold">
                                ...
                                <a href="login.php">
                                    <i class="far fa-heart" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        title="Add To Favourate Plese First Login">
                                    </i>
                                </a>&nbsp;&nbsp;&nbsp;&nbsp;
                                <?php } ?>
                            ...
                            <a href="furniture_detail.php?funid=<?php echo $fetch['furniture_id']; ?>">
                                <button class="wooden-main2-button text-white rounded mb-0 fs-6 text-decoration-none">See More</button>
                            </a>
                        </div>
                    </div>
                </div>
